...
from .models import (User, Person, Company, PersonType,
                     Bio, Skill, Education, Institute, Language,
                     Experience, SearchableField, UserIncentives)
...
class PersonAdmin(admin.ModelAdmin):
    form = PersonAdminForm
    list_display = ('id', 'email', 'first_name', 'last_name', 'phone',
                    'date_joined', 'get_typs', 'gender', 'image_count')
...
class EducationAdmin(admin.ModelAdmin):
    list_display = ('person', 'institute', 'start_date', 'end_date', 'degree',
                    'grade', 'field_of_study', 'social_activites', 'description')
...
class InstituteAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'institute_name', 'established_year', 'location',)
...
class ExperienceAdmin(admin.ModelAdmin):
    ...
    list_display = ('production_house', 'title', 'role', 'person',)
