...
class Image(CommonFieldsMixin):
    ...
    is_private = models.BooleanField(
        default=False, help_text="Weather the image is private or public."
    )
    image_type = models.CharField(
        max_length=1, choices=choices.MEDIA_TYPE_CHOICES, default=choices.GENERIC
    )
...
class Video(CommonFieldsMixin):
    ...
    is_private = models.BooleanField(
        default=False, help_text="Weather the video file is private or public."
    )
...
class Audio(CommonFieldsMixin):
    ...
    is_private = models.BooleanField(
        default=False, help_text="Weather the audio file is private or public."
    )
