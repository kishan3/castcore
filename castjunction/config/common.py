...
ADMIN_EMAILS = ['gagan_stage@mailinator.com',
...
# General
APPEND_SLASH = environ.Env(APPEND_SLASH=(bool, False),)
TIME_ZONE = 'UTC'
LANGUAGE_CODE = 'en-us'
...
GRAPPELLI_AUTOCOMPLETE_SEARCH_FIELDS = {
    "cities": {
        "city": ("id__iexact", "name_std__icontains",)
    }
}
